...
def main():
    ...
    while True:
        ...
        choice = input("Seçiminizi yapın: ")
        #Seçeneğe Göre Tanımladığımız Metodları Çağırdık
        if choice == "1":
            print("\n--- Depo Ekle ---")
            name = input("Depo Adı: ")
            phone = input("Telefon: ")
            ...
            break
        elif choice == "10" and authority == "1":  # Eğer kullanıcı yönetici ise
            print("\n--- Yönetici Ekle ---")
        ...
        elif choice == "11" and authority == "1":  # Eğer kullanıcı yönetici ise
            print("\n--- Kullanıcı Listele ---")
            User.list_users(db,user_id)
           
        elif choice == "12" and authority == "1":  # Eğer kullanıcı yönetici ise
